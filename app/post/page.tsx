  ...
  return (
    <div className='h-screen w-screen flex flex-col items-center justify-start'>
      <div className='fixed w-screen bg-white z-10 border-b-[5px] border-green-700'>
        <h1 className="text-[25px] font-bold p-[30px]">Blog Post Management Application</h1>
        <button className='fixed top-0 font-semibold right-0 mt-[30px] mx-3 bg-green-700 px-[20px] py-[10px] text-[12px] rounded-[25px] text-white hover:bg-green-500 hover:text-green-800' onClick={openModal}>+ Add New</button>
      </div>
      <div className='flex flex-col items-center mt-[100px] bg-green-100 bg-opacity-50 w-screen h-auto py-5 border-b-[5px] border-green-700'>
      ...
      <Link className='absolute z-15 h-[50px] w-[50px] bg-green-800 bottom-0 left-0 m-5 rounded-full shadow-xl hover:cursor-pointer' href={"/"}>A</Link>
    </div>
  );
};
